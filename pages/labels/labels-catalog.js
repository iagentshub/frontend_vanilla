(function () {
    ...
    var _SVG_INFO = '<svg width="9" height="9" viewBox="0 0 16 16" fill="none"><circle cx="8" cy="8" r="6.5" stroke="currentColor" stroke-width="1.5"/><path d="M8 7v4M8 5.5v.5" stroke="currentColor" stroke-width="1.5" stroke-linecap="round"/></svg>';
    ...
    function _render() {
        ...
        LABELS.GROUPS.forEach(function (group) {
            ...
            group.labels.forEach(function (lbl) {
                ...
                var isInfo = _INFO_KEYS.indexOf(lbl.key) !== -1;
                if (isBlocked) {
                    ...
                    html += '<span class="lcat-label-behavior" style="color:var(--accent,#6366f1);background:color-mix(in srgb,#6366f1 10%,transparent)">' + _SVG_INFO + ' ' +
                        (window.t ? t('labels.catalog.info') : 'Informational') + '</span>';
                }
                if (isDefault) {
