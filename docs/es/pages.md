...
| **Perfil** | Ajustes del usuario: tema visual y contraseña. Incluye la pestaña **Proveedores** para gestionar las credenciales base de cada proveedor de IA (claves de API, host de Ollama, etc.) y la pestaña **Grupos** para crear equipos de colaboración, gestionar miembros, enviar invitaciones y ver los recursos compartidos con cada equipo. Los invitados no pueden crear ni unirse a grupos. |
| **Administración** | Panel de control del sistema. Solo accesible para administradores. Incluye las secciones **General** (estadísticas), **Usuarios**, **Grupos** (ver, filtrar y eliminar equipos; consultar miembros y contenido compartido de cada grupo), **Agentes**, **Conexiones**, **Conocimiento** y **Logs**. |
